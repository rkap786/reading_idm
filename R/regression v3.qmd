...
ny.adj.mat= getlinearscale(nwea_ny_ability,f, state="NY", start=0.3, end=0.7)
tx.adj.mat= getlinearscale(tx_ability,f, state="Texas", start=0.3, end=0.7)
...
# write_csv(f, "Data/Data/Processed/file-1053items.csv")
...
### Alternate PCA embeddings
pca_embeddings_80_llama= getpc(embed.llama)
